...
**バックアップ実体(2026-09-13、rpi-geoserver0担当セッションが作成・報告)**:
`m329-kaga0-20260913.img`(31.0GB、元SDカードと完全一致。sha256:
`1023c149469bd5b494e46df6fc5550fd57122a3350dff9879f6cc343a5b43d10`)。
復元手順は同ディレクトリの`m329-kaga0-20260913.README.md`参照。
**このkaga0セッションからは`slate.local`へのアクセス手段が無く、上記の
存在・整合性を直接検証できていない**——他セッションからの報告をそのまま
記録したもの。復元が必要になった際は、まず藤村さんに現物の存在を
確認してもらうこと。
